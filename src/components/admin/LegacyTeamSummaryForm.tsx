  ...
  return (
    <label className="flex flex-col gap-1">
      ...
      <input
        ...
        className="h-10 w-full rounded-lg border border-gray-200 bg-white text-center text-sm font-semibold text-gray-900 focus:border-brand focus:outline-none focus:ring-2 focus:ring-brand/30 sm:w-24"
      />
    </label>
  );
}
